...
The package is grown over the last years and reflects many developments and lessons learned from our research projects with time-resolved experimental data from Systems Biology. They form the basis of the development of \pkg{dMod} and are mostly referenced in the following paragraphs.\\
The aim and core functionality of \pkg{dMod} is
\begin{enumerate}[(i)]
